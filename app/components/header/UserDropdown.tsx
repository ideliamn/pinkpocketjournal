...
export default function UserDropdown() {
    ...
    return (
        <div className="relative">
            ...
            <button onClick={toggleDropdown} className="px-4 py-2 flex items-center dropdown-toggle cursor-pointer hover:bg-white/70 hover:text-pink-600 hover:underline">
